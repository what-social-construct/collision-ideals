...
family, the common embeddings in \(N/T\), and the ideal containment
\((\mathrm{SFTL}_C)\) remain to be constructed.  These prospective objects
are kept behind \leanpath{CollisionIdeals/Planar/Research.lean}, outside the
stable import spine.
\end{leanfiles}
